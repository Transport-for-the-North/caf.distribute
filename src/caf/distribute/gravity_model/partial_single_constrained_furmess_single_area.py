...
class SingleAreaGravityModelCalibrator(core.GravityModelBase):
    ...
    def _gravity_function(
        ...
        **kwargs,
        ...
        seed_vals = seed_vals.mul(self.weights.squeeze(), axis=0)

        # Furness trips to trip ends
        matrix, iters, rmse = furness.partial_single_constrained_furness(
            seed_vals=seed_vals,
    ...
    def _jacobian_function(
        ...
        **kwargs,
        ...
        base_matrix = base_matrix.mul(self.weights.squeeze(), axis=0)
        ...
        for i, cost_param in enumerate(self.cost_function.kw_order):
            ...
            adj_base_mat = adj_base_mat.mul(self.weights.squeeze(), axis=0)
            ...
            adj_final, *_ = furness.partial_single_constrained_furness(
                seed_vals=adj_final,
